  ...
  return (
    <>
      <style>{`
        ...
        .wa-btn:hover .wa-icon { transform: scale(1.1) rotate(-8deg); }
      `}</style>
      ...
      <div style={{
        ...
        {showTooltip && (
          <div onClick={() => setShowTooltip(false)} style={{
            background: "#fff", color: "#1a1a1a", padding: "10px 16px",
            borderRadius: 12, borderBottomRightRadius: 4,
            fontFamily: T.font.body, fontSize: 13, fontWeight: 600,
            boxShadow: "0 4px 24px rgba(0,0,0,0.15)",
            animation: "wa-tooltip-in 0.4s ease-out",
            cursor: "pointer", maxWidth: 200, lineHeight: 1.4,
          }}>
        ...
        <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
          ...
          style={{
            ...
            animation: hasAnimated ? "none" : "wa-bounce 2s ease 3s",
        ...
        >
          ...
          {/* WhatsApp Icon */}
          <svg className="wa-icon" width="30" height="30" viewBox="0 0 24 24" fill="white" style={{ transition: "transform 0.3s ease", position: "relative", zIndex: 1 }}>
